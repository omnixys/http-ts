...
> Repository development instructions for **http** (Shared Package).
> Stack: ts-package. Generated as part of the Omnixys repository-policy rollout.

## Repository Overview

Omnixys HTTP helpers for TypeScript.

- Repository path: `packages/ts/http` (relative to the Omnixys root)
