<!-- repository: packages/ts/http | kind: PACKAGE | stack: ts-package -->

# http — Skill: Package Development

> Workflow for http (packages/ts/http). Execute this workflow before, during, and
...
- This package is published (`@omnixys/http-ts`); consumers pin versions and rely on SemVer.
